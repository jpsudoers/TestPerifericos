package com.vigatec.testaplicaciones.entity;
...
/**
 * EMV Card-seeking parameters
 * - searchCard Interface Supports all parameters
 * - startPrcoess Interface Does not support magnetic stripe cards, so the relevant parameters of
 *   magnetic stripe cards are invalid, such as supportMagCard, trackCheckEnabled, lrcCheckEnabled,
 *   ctrlFlagEnabled, trkIdWithWholeData
 */
